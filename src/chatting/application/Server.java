...
public class Server extends JFrame implements ActionListener{
    ...
    Server(){
        ...
        add(p1);
         ...
         Image i2 = i1.getImage().getScaledInstance(15,17,Image.SCALE_DEFAULT);
         ImageIcon i3 = new ImageIcon(i2);
         JLabel l1 = new JLabel(i3);
         l1.setBounds(10,17,15,17);
         p1.add(l1);
         ...
         ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("chatting/application/icons/1IMG.jpg"));
         ...
         Image i14 = i13.getImage().getScaledInstance(17,25, Image.SCALE_DEFAULT);
         ImageIcon i15 = new ImageIcon(i14);
         JLabel l7 = new JLabel(i15);
         l7.setBounds(400,15,17,25);
         p1.add(l7);
